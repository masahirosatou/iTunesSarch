...
public class ListActivity extends AppCompatActivity {
    ...
    //参考API資料https://syncer.jp/itunes-api-matome
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new ListAdapter(ListActivity.this,R.layout.list_item);
    ...
    private  class OnItemClickListener implements AdapterView.OnItemClickListener{
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            intent.putExtra("artwork_Url100", result.optString("artworkUrl100"));
            intent.putExtra("track_name", result.optString("trackName"));
            intent.putExtra("artist_Name", result.optString("artistName"));
